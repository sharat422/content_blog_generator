          ...
          <div className="prose prose-gray max-w-none space-y-8">
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                By accessing and using WriteSwift ("the Service"), you agree to be bound by these Terms of Service. 
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                WriteSwift is a content and blog generation platform that leverages artificial intelligence to help
            ...
            <section className="space-y-4">
              ...
              <div className="text-muted-foreground leading-relaxed space-y-2">
                <p>When using WriteSwift, you agree not to:</p>
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                WriteSwift shall not be held liable for any indirect, incidental, or consequential damages, 
